                ...
                <tr>
                    ...
                    <td>
                        ...
                        <form action="/dashboard/articlecategories/{{ $articlecategory->slug }}" method="POST" class="d-inline">
                            @method('delete')
                            @csrf
                            <button class="badge bg-danger border-0" onclick="return confirm('Menghapus kategori ini akan menghapus artikel juga!')"><span data-feather="x-circle"></span></button>
                        </form>  
                    </td>  
                </tr>
            @endforeach
